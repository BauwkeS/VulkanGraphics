...
//            Input::KeyHeld(GLFW_KEY_W) - Input::KeyHeld(GLFW_KEY_S));
//        m_OriginTarget += m_Forward * speed * forwardInput;
//
//        const float rightInput = static_cast<float>(
//            Input::KeyHeld(GLFW_KEY_A) - Input::KeyHeld(GLFW_KEY_D));
//        m_OriginTarget += m_Right * speed * rightInput;
//
//        const float UpInput = static_cast<float>(Input::KeyHeld(GLFW_KEY_E)
//            - Input::KeyHeld(GLFW_KEY_Q));
...
//        auto&& mouseData{ Input::MouseData() };
//
//        if (glm::length(mouseData) != 0
//            && Input::ButtonHeld(GLFW_MOUSE_BUTTON_RIGHT))
//        {
