...
{
    //When you make a material ::
    // - Allocate another descriptor for the new material
    // - Update descriptor sets with info from each texture in the material
    // (this should be the same size as the original amount allocated)
